<template>
  <q-page id="savedRoutes">
    <q-toolbar class="text-white bg-teal-8">
      ...
      <q-btn to="/route/saved-routes" flat round dense icon="add" size="20px" />
    </q-toolbar>
    ...
    <div class="text-center q-pt-lg">
      ...
      <div class="q-pa-md info">
        This is where you can add your most favourite or common journeys
      </div>
    </div>

    <q-scroll-area class="list q-pa-md">
      <q-list>
        <q-item>
          ...
          <q-item-section>
            ...
            <q-item-label caption>
              <div class="q-px-sm">
                <b>From</b>: This is the from section
              </div>
              <div class="q-px-sm">
                <b>to</b>: This is the from section
              </div>
              <div class="q-px-sm">
                <b>Search Radius</b>: 3
              </div>
          ...
          <q-item-section side bottom>
            ...
            <q-btn class="q-mx-sm" label="Delete" color="red" size="sm"/>
          </q-item-section>
        </q-item>
      </q-list>
    </q-scroll-area>
